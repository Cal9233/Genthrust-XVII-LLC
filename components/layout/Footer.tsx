  ...
  return (
    <footer className="relative bg-navy-950 border-t border-navy-800">
      <div className="container mx-auto px-4 md:px-6 py-12">
            ...
            <ul className="space-y-1">
              {FOOTER_LINKS.quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-slate-400 hover:text-white transition-colors text-sm py-2 block"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-navy-800 flex flex-col md:flex-row justify-between items-center gap-4">
